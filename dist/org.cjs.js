...
const Syntax = {
  ...
  define: function (name, syntax) {
    ...
    const methodName = "is" + name.substring(0, 1).toUpperCase() + name.substring(1);
...
function Converter$1(orgDocument, exportOptions) {
...
function HTML(orgDocument, exportOptions) {
  Converter$1.call(this, orgDocument, exportOptions);
...
inheritPrototype(HTML, Converter$1);
